...
\begin{itemize}
  ...
  \item \verb+Eigen::VectorXd previous_output+ vecteur des sorties de la cellule à l'instant $t-1$ ;
  \item \verb+Eigen::VectorXd previous_cell_state+ mémoire de la cellule à l'instant $t-1$ ;
  \item \verb+Eigen::VectorXd input_gate_out+ sortie du noeud input\_gate à l'instant $t$ ;
  \item \verb+Eigen::VectorXd input_block_out+ sortie du noeud input\_block à l'instant $t$ ;
  \item \verb+Eigen::VectorXd output_gate_out+ sortie du noeud output\_gate à l'instant $t$ ;
  \item \verb+Eigen::VectorXd cell_state+ mémoire de la cellule à l'instant $t$ ;
